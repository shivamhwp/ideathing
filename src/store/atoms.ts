...
export type OwnerType = "Theo" | "Phase" | "Mir" | "flip" | "melkey" | "gabriel" | "ben" | "shivam" | "";
export type ChannelType = "C:Main" | "C:Rants" | "C:Throwaways" | "C:Other" | "C:Main(SHORT)" | "";
export type LabelType = "Requires Planning" | "Priority" | "Mid Priority" | "Strict deadline" | "Sponsored" | "High Effort" | "Worth it?" | "Evergreen" | "Database Week" | "";
export type StatusType = "To Record(Off stream)" | "To Stream" | "Recorded" | "Editing" | "Done Editing" | "NEEDS THUMBNAIL" | "Ready To Publish" | "Scheduled" | "Published" | "Concept" | "Commited" | "dead" | "Shorts" | "2nd & 3rd Channel" | "Needs sponsor spot" | "Theo's Problem" | "";
...
export const newIdeaRecordedAtom = createDraftFieldAtom(
	newIdeaDraftAtom,
	"recorded",
);
...
export const editIdeaRecordedAtom = createDraftFieldAtom(
	editIdeaDraftAtom,
	"recorded",
);
