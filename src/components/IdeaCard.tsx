...
export function IdeaCard({ idea, onClick, organizationId }: IdeaCardProps) {
	...
	return (
		<div
			...
			style={style}
			role="card"
			className={cn("group cursor-pointer", isSortableDragging && "opacity-0")}
			onClick={handleClick}
		>
			{/* Compact card */}
				...
				>
					...
					<div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
						<button
							...
							className="hover:bg-red-600/60 text-red-400 hover:text-white/70 cursor-pointer rounded-md p-1.5 transition-colors duration-100"
							title="Delete"
						>
