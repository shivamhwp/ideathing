    ...
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground px-4">
      <div className="max-w-md text-center space-y-4">
        {loaderData.status === "success" && (
          <>
            <CheckCircleIcon className="w-12 h-12 text-green-500 mx-auto" weight="fill" />
            <p className="text-lg font-medium text-green-600">Successfully connected to Notion!</p>
        ...
        {loaderData.status === "error" && (
          <>
            <XCircleIcon className="w-12 h-12 text-destructive mx-auto" weight="fill" />
