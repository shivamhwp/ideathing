1. Never run "bun run dev" command.
2. Always after you are done making changes, run "bun run lint" and "bun run type-check" command to check for lint errors and type errors and fix them.
...
7. Always use inferrered types. or atleast whenver possible.
